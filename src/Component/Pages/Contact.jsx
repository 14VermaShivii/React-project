...
import { faGreaterThan, faLocationPin, faPhone } from "@fortawesome/free-solid-svg-icons"
            ...
            <div className="col-md-12">
                <div className="main-titles-head left-border">
                    <div className="row px-4">
                        <h2>Get In Touch</h2>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic fuga sit illo
                        <br />modi aut aspernatur
        ...
        <div className="container">
            <div className="row py-5">
                <div className="col-md-4 ">
                    <label className="FontAwesomeIcon"><FontAwesomeIcon icon={faPhone} />
                        <span className="px-3 text-color">Call
                            us</span> </label>
                ...
                <div className="col-md-4">
                    ...
                    <label className="FontAwesomeIcon">
                         <FontAwesomeIcon icon={faEnvelope} />
                    <span className="px-3 text-color">Email Us</span></label>
                    <div className="cont-top margin-up">
                        ...
                        <div className="cont-right">
                            ...
                            <p className="para text-dark"><NavLink href="mailto:example@mail.com"
                                className="mail text-color">example@mail.com</NavLink>
                            </p>
                        </div>
                    </div>
                </div>
                <div className="col-md-4">
                    <label className="FontAwesomeIcon"><FontAwesomeIcon icon={faLocationPin} />
                        <span className="px-3 text-color">Address</span></label>
                    <div className="cont-top margin-up">
                        <div className="cont-left text-center">
